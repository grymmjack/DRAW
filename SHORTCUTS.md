...
<!-- BINDINGS:START -->
<!-- GENERATED by `DRAW --dump-shortcuts` from the input registry (219 bindings).
...
| Trigger | Action | Dispatch |
|---------|--------|----------|
| `H` | Flip horizontal | legacy |
| `Ctrl+Shift+H` | Flip vertical | legacy |
...
| Trigger | Action | Dispatch |
|---------|--------|----------|
| `Ctrl+F` | Redo Last Effect (Ctrl+F) | legacy |
| `Ctrl+Alt+F` | Recall Last Effect (Ctrl+Alt+F) | legacy |
| `Ctrl+Shift+F` | Blend Last Effect (Ctrl+Shift+F) | legacy |
...
| `Ctrl+Wheel up` | Canvas: Ctrl+Wheel zoom in | legacy |
| `Ctrl+Wheel down` | Canvas: Ctrl+Wheel zoom out | legacy |
| `Wheel up` | Canvas: Wheel up (brush size or scroll) | legacy |
| `Wheel down` | Canvas: Wheel down | legacy |
