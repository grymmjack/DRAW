#!/bin/bash
# =============================================================================
# effect-texture-more.sh — QA test / regression guard
#
# EFFECTS > TEXTURE > Brushed Metal(3), Weave(4), and the Clouds re-parent(5).
...
#   open_effect 8 3 / 8 4 / 8 5
# =============================================================================

info "=== Effect: TEXTURE more (Brushed Metal/Weave/Clouds) Test ==="
...
texture_case 3 "brushmetal"
texture_case 4 "weave"
texture_case 5 "texclouds"
