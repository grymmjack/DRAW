...
park_mouse
snap_region $(( CANVAS_CX - 80 )) $(( CANVAS_CY - 60 )) 160 120 "opacity-before"
BEFORE="$SNAP_RESULT"
assert_no_crash
...
park_mouse
snap_region $(( CANVAS_CX - 80 )) $(( CANVAS_CY - 60 )) 160 120 "opacity-50pct"
AFTER_50="$SNAP_RESULT"
...
park_mouse
snap_region $(( CANVAS_CX - 80 )) $(( CANVAS_CY - 60 )) 160 120 "opacity-100pct"
AFTER_100="$SNAP_RESULT"
...
park_mouse
snap_region $(( CANVAS_CX - 80 )) $(( CANVAS_CY - 60 )) 160 120 "opacity-undone"
