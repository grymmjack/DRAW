#!/bin/bash
# =============================================================================
# effect-texture-voronoi.sh — QA test / regression guard
#
# EFFECTS > TEXTURE > Stone Wall(11), Reptile Skin(12).
...
#   open_effect 8 11 / 8 12
# =============================================================================

info "=== Effect: TEXTURE more (Stone/Reptile) Test ==="
...
texture_case 11 "stone"
texture_case 12 "reptile"
