#!/bin/bash
# =============================================================================
# effect-texture-natural.sh — QA test / regression guard
#
# EFFECTS > TEXTURE > Ripples(8), Animal Fur(9), Texture Noise(10).
...
#   open_effect 8 8 / 8 9 / 8 10
# =============================================================================

info "=== Effect: TEXTURE more (Ripples/Fur/Noise) Test ==="
...
texture_case 8 "ripples"
texture_case 9 "fur"
texture_case 10 "texnoise"
