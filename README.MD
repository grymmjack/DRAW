...
- **Spray** - Spray paint with adjustable radius and density
...
### User Interface
- Themeable PNG icon toolbar (20 buttons in 2x10 grid)
...
**Tools:** B (Brush), D (Dot), F (Fill), I (Picker), K (Spray), L (Line), R (Rectangle), E (Ellipse)  
