...
3. Compile with compile_and_verify_qb64pe and iterate until it builds clean
4. If the program uses graphics, add _SAVEIMAGE near END and call analyze_qb64pe_graphics_screenshot