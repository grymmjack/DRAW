# DRAW — Keyboard & Mouse Shortcuts

**Quick reference · v2.0.0 · 2026-08-26**

> **Primary** = Ctrl (Windows/Linux) or ⌘ Cmd (macOS).  **Hold X + …** = hold that key, then press/click/drag.  **L/R/M-Click** = left / right / middle mouse · **Wheel** = scroll.  Keys only do the listed thing when not typing in a text field.
